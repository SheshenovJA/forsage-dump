...
<html>
	<head>
		<meta charset="utf-8">
		<title>Forsage - Автозапчастини у Львові та Україні</title>
    	...
    	<div class="carousel fade-carousel slide" data-ride="carousel" data-interval="5000" id="bs-carousel">
    		...
    		<div class="carousel-inner">
    			...
    			<div class="item slides active">
    				...
    				<div class="hero">
    					<hgroup>
    						<h1>Автозапчастини у Львові та Україні</h1>
    		...
    		<div class="item slides">
    			...
    			<div class="hero">
    				<hgroup>
    					<h2>Безкоштовна доставка по <i class="icon-md ion-android-pin"></i> Львову</h3>
    					<h2>при замовленні від 3000 грн</h3>
    				</hgroup>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-md-offset-3 text-center">
					...
					<hr class="dark">
					<p class="dark">Все, що для цього потрібно - це заповнити форму нижче. Для більш точного пошуку автозапчастини, скористайтесь <a href="https://www.ilcats.ru/">оригінальною базою</a> та введіть код деталі та іншу необхідну інформацію у поле "Опис".</p>
					<form role="form" id="contactForm" data-toggle="validator" class="shake">
						...
						<button type="submit" id="form-submit" class="btn btn-order btn-xl pagination-centered">Замовити</button>
	...
	<section class="container-fluid" id="three">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="margin-top-0 text-primary">Умови та терміни доставки</h2>
					<hr>
					<div>
	...
	<section class="container-fluid" id="four">
		<div class="row">
			<div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
				<h2 class="text-center text-primary">Наші переваги</h2>
				<hr class="dark">
				<div class="media wow fadeInRight">
	...
	<section id="last">
		<div class="container">
		<h2 class="text-center text-primary">Контакти</h2>
		<hr class="dark">
		<div class="row-fluid">
            ...
            <div class="modal-content">
            	<div class="modal-body">
            		...
            		<h5 class="text-center">
            		    Онлайн магазин у стадії розробки :)
            		</h5>
